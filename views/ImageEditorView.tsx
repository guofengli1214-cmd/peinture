...
export const ImageEditorView: React.FC<ImageEditorViewProps> = ({
  ...
  const [galleryLocalUrls, setGalleryLocalUrls] = useState<
    ...
    <div className="w-full h-full flex flex-grow flex-col md:max-w-7xl md:mx-auto relative">
      ...
      >
        ...
        <div
          ...
          onTouchEnd={handleMouseUp} // Simplified touch for brevity
        >
          {image && (
            <img
              src={image.src}
        ...
        {contextMenu && (
          <>
            ...
            >
              ...
              >
                <LogOut className="w-4 h-4 text-red-400 group-hover:scale-110" />
                {t.menu_exit}
              </button>
            </div>
          </>
                  ...
                  {history.map((img) => (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-3">
                        <p className="text-xs text-white/90 line-clamp-2 text-left">
                          {img.prompt}
                        </p>
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-3">
              ...
              <ShortcutRow
                label={t.sc_move}
                keys={["M", t.or_conjunction.trim(), "0"]}
              />
              <ShortcutRow
                label={t.sc_draw}
                keys={["D", t.or_conjunction.trim(), "1"]}
              />

              <ShortcutRow
                label={t.sc_rect}
                keys={["R", t.or_conjunction.trim(), "2"]}
              />
              <ShortcutRow
                label={t.sc_eraser}
                keys={["E", t.or_conjunction.trim(), "3"]}
              />
              ...
              <ShortcutRow
                label={t.sc_color}
                keys={["C", t.or_conjunction.trim(), "5"]}
              />
