...
interface StorageTabProps {
  activeTab: string;
  s3Config: S3Config;
  setS3Config: (v: S3Config) => void;
  webdavConfig: WebDAVConfig;
  setWebdavConfig: (v: WebDAVConfig) => void;
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <input
              type="text"
              value={props.s3Config.accessKeyId}
              onChange={(e) =>
                props.setS3Config({
                  ...props.s3Config,
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="relative w-full">
              <input
                ...
                value={props.s3Config.secretAccessKey}
                onChange={(e) =>
                  props.setS3Config({
                    ...props.s3Config,
          ...
          <div className="flex gap-4">
            <div className="flex-1 space-y-1">
              ...
              <input
                type="text"
                value={props.s3Config.publicDomain || ""}
                onChange={(e) =>
                  props.setS3Config({
                    ...props.s3Config,
            ...
            <div className="flex-1 space-y-1">
              ...
              <input
                type="text"
                value={props.s3Config.prefix ?? "peinture/"}
                onChange={(e) =>
                  props.setS3Config({
                    ...props.s3Config,
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-end">
              <button
                onClick={props.handleTestS3}
                disabled={props.isTestingS3}
            ...
            {props.testS3Result && (
              <div
                className={`p-3 rounded-lg border text-xs flex items-start gap-2 ${props.testS3Result.success ? "bg-green-500/10 border-green-500/20 text-green-400" : "bg-red-500/10 border-red-500/20 text-red-400"}`}
              >
                {props.testS3Result.success ? (
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <input
              type="text"
              value={props.webdavConfig.url}
              onChange={(e) =>
                props.setWebdavConfig({
                  ...props.webdavConfig,
                  url: e.target.value,
                })
              }
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <input
              type="text"
              value={props.webdavConfig.username}
              onChange={(e) =>
                props.setWebdavConfig({
                  ...props.webdavConfig,
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="relative w-full">
              <input
                ...
                value={props.webdavConfig.password}
                onChange={(e) =>
                  props.setWebdavConfig({
                    ...props.webdavConfig,
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <input
              type="text"
              value={props.webdavConfig.directory}
              onChange={(e) =>
                props.setWebdavConfig({
                  ...props.webdavConfig,
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-end">
              <button
                onClick={props.handleTestWebDAV}
                disabled={props.isTestingWebDAV}
            ...
            {props.testWebDAVResult && (
              <div
                className={`p-3 rounded-lg border text-xs flex items-start gap-2 ${props.testWebDAVResult.success ? "bg-green-500/10 border-green-500/20 text-green-400" : "bg-red-500/10 border-red-500/20 text-red-400"}`}
              >
                {props.testWebDAVResult.success ? (
                  <Check className="w-4 h-4 mt-0.5 flex-shrink-0" />
                ) : (
                  <AlertCircle className="w-4 h-4 mt-0.5 flex-shrink-0" />
                )}
